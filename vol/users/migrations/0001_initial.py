    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.SlugField(max_length=30, unique=True, verbose_name='Ник')),
                ...
                ('status', models.CharField(choices=[('S', 'Разработчик'), ('B', 'Модератор'), ('D', 'Обычный пользователь')], default='D', max_length=1)),
